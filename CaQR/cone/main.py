...
def parse_args(args=None):
    ...
    parser.add_argument('--note', type=str, default='exp38', help="name of exp")
    ...
    parser.add_argument('-cpu', '--cpu_num', default=5, type=int, help="used to speed up torch.dataloader")
...
def main(args):
    ...
    args.save_path = os.path.join('logs', args.data_path.split('/')[-1],
                                  '{}_{}'.format(args.tasks, args.note))
